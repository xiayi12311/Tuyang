---@class Level_2_C:STExtraSimpleCharacter
...
Level_2.gold = 100 
--Level_2.RespwanClass = UE.LoadClass(UGCGameSystem.GetUGCResourcesFullPath('Asset/Blueprint/Enemy/Level_2/Respawn/Scorpion_Respawn.Scorpion_Respawn_C'))
Level_2.HasPlay = false
...
Level_2.CampID = 0
function Level_2:ReceiveBeginPlay()
    Level_2.SuperClass.ReceiveBeginPlay(self)
    ugcprint("Level_2 begin")
...
function Level_2:OnTakeDamageDelegate(Damage,EventInstigator,DamageEvent,DamageCauser)
...
function Level_2:ReceiveTick(DeltaTime)
    Level_2.SuperClass.ReceiveTick(self, DeltaTime)
...
function Level_2:ReceiveEndPlay()
    Level_2.SuperClass.ReceiveEndPlay(self) 
...
--[[
function Level_2:GetReplicatedProperties()
    return
end
--]]

--[[
function Level_2:GetAvailableServerRPCs()
    return
end
--]]
function Level_2:ReceiveEnd()
    IsRespawn =false
