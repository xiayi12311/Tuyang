---@class Level_17_C:STExtraSimpleCharacter
...
--Level_17.RespwanClass = UE.LoadClass(UGCGameSystem.GetUGCResourcesFullPath('Asset/Blueprint/Enemy/Tesla/Level_17/Respawn/Tesla_1_Respawn.Tesla_1_Respawn_C'))
--DropItemConfig = require("Script.DropItemConfig")
--UGCDropItemMgr = require("Script.UGCDropItemMgr")
Level_17.gold = 120
Level_17.HasPlay = false
...
Level_17.CampID = 0
function Level_17:ReceiveBeginPlay()
    Level_17.SuperClass.ReceiveBeginPlay(self)
...
--
function Level_17:OnTakeDamageDelegate(Damage,EventInstigator,DamageEvent,DamageCauser)
...
function Level_17:ReceiveTick(DeltaTime)
    Level_17.SuperClass.ReceiveTick(self, DeltaTime)
...
function Level_17:ReceiveEndPlay()
    Level_17.SuperClass.ReceiveEndPlay(self) 
	--local BP_Drop = ScriptGameplayStatics.SpawnActor(self,DropParticle,self:K2_GetActorLocation(),{Roll = 0, Pitch = 0, Yaw = 0},{X = 1, Y = 1, Z = 1});
...
--[[
function Level_17:GetReplicatedProperties()
    return
end
--]]

--[[
function Level_17:GetAvailableServerRPCs()
    return
end
--]]

-- [Editor Generated Lua] function define Begin:
function Level_17:LuaInit()
...
function Level_17:Mesh_OnAnimInitialized()
	return nil;
end

function Level_17:Die()
    local Montage = UE.LoadObject()
    self.Mesh:PlayAnimation()
end
-- [Editor Generated Lua] function define End;

function Level_17:ReceiveEnd()
	IsRespawn =false
