...
function SpawnTesla_1:GetMonsterClass()
    local path = UGCGameSystem.GetUGCResourcesFullPath('Asset/Blueprint/Enemy/Tesla/Tesla_3/Tesla_3.Tesla_3_C')--UGCGameSystem.GetUGCResourcesFullPath('Asset/Blueprint/Enemy/Tesla/Tesla_3/Tesla_3.Tesla_3_C')
