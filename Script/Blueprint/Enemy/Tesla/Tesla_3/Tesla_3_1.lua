---@class Tesla_3_1_C:STExtraSimpleCharacter
...
--Tesla_3.RespwanClass = UE.LoadClass(UGCGameSystem.GetUGCResourcesFullPath('Asset/Blueprint/Enemy/Tesla/Tesla_3/Respawn/Tesla_3_Respawn.Tesla_3_Respawn_C'))
DropItemConfig = require("Script.DropItemConfig")
UGCDropItemMgr = require("Script.UGCDropItemMgr")
local EventSystem =  require('Script.common.UGCEventSystem')
Tesla_3.gold = 200
Tesla_3.HasPlay = false
...
function Tesla_3:ReceiveBeginPlay()
    Tesla_3.SuperClass.ReceiveBeginPlay(self)
...
function Tesla_3:OnTakeDamageDelegate(Damage,EventInstigator,DamageEvent,DamageCauser)
...
function Tesla_3:ReceiveTick(DeltaTime)
    Tesla_3.SuperClass.ReceiveTick(self, DeltaTime)
...
function Tesla_3:ReceiveEndPlay()
    Tesla_3.SuperClass.ReceiveEndPlay(self) 
    local BP_Drop = ScriptGameplayStatics.SpawnActor(self,DropParticle,self:K2_GetActorLocation(),{Roll = 0, Pitch = 0, Yaw = 0},{X = 1, Y = 1, Z = 1});
