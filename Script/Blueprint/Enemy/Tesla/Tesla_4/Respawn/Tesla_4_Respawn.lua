---@class Tesla_4_Respawn_C:AActor
---@field DefaultSceneRoot USceneComponent
--Edit Below--
local Tesla_4_Respawn = {}
Tesla_4_Respawn.MonsterClass = UE.LoadClass(UGCGameSystem.GetUGCResourcesFullPath('Asset/Blueprint/Enemy/Tesla/Tesla_4/Tesla_4.Tesla_4_C'))
