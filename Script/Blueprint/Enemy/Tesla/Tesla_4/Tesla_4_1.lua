---@class Tesla_4_1_C:STExtraSimpleCharacter
...
--Tesla_4.RespwanClass = UE.LoadClass(UGCGameSystem.GetUGCResourcesFullPath('Asset/Blueprint/Enemy/Tesla/Tesla_4/Respawn/Tesla_4_Respawn.Tesla_4_Respawn_C'))
