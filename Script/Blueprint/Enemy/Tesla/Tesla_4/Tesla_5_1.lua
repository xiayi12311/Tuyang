---@class Tesla_5_1_C:STExtraSimpleCharacter
...
--Tesla_4.RespwanClass = UE.LoadClass(UGCGameSystem.GetUGCResourcesFullPath('Asset/Blueprint/Enemy/Tesla/Tesla_4/Respawn/Tesla_4_Respawn_2.Tesla_4_Respawn_2_C'))
local EventSystem =  require('Script.common.UGCEventSystem')
DropItemConfig = require("Script.DropItemConfig")
UGCDropItemMgr = require("Script.UGCDropItemMgr")
Tesla_4.gold = 200
Tesla_4.HasPlay = false
...
function Tesla_4:ReceiveBeginPlay()
    Tesla_4.SuperClass.ReceiveBeginPlay(self)
...
--
function Tesla_4:OnTakeDamageDelegate(Damage,EventInstigator,DamageEvent,DamageCauser)
...
function Tesla_4:ReceiveTick(DeltaTime)
    Tesla_4.SuperClass.ReceiveTick(self, DeltaTime)
...
function Tesla_4:ReceiveEndPlay()
    Tesla_4.SuperClass.ReceiveEndPlay(self) 
    local BP_Drop = ScriptGameplayStatics.SpawnActor(self,DropParticle,self:K2_GetActorLocation(),{Roll = 0, Pitch = 0, Yaw = 0},{X = 1, Y = 1, Z = 1});
