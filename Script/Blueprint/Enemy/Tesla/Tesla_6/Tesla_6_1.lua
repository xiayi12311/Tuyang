---@class Tesla_6_1_C:STExtraSimpleCharacter
...
--Tesla_4.RespwanClass = UE.LoadClass(UGCGameSystem.GetUGCResourcesFullPath('Asset/Blueprint/Enemy/Tesla/Tesla_6/Respawn/Tesla_6_Respawn.Tesla_6_Respawn_C'))
