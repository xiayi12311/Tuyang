---@class Sniperbombp_C:UGC_BulletBall_C
...
function DaoDan:ReceiveEndPlay()
    ...
    ugcprint("EmmitStart")
    local BoolKey = UGCGameSystem.ApplyRadialDamage(10,10,self:K2_GetActorLocation(),500,500,0, EDamageType.RadialDamage,nil,self:GetInstigator(),self:GetInstigatorController(),ECollisionChannel.ECC_Visibility, 0);
