---@class Sniper1_C:UGC_Snipe_BP_C
--Edit Below--
local SNIPER = 
{
...
SNIPER.gold = 20
SNIPER.RespwanClass = UE.LoadClass(UGCGameSystem.GetUGCResourcesFullPath('Asset/Blueprint/Enemy/Sniper/Respawn/Sniper_Respawn.Sniper_Respawn_C'))
SNIPER.HasPlay = false
