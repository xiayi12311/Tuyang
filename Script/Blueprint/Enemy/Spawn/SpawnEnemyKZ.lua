...
local EntryParticle = UE.LoadClass(UGCGameSystem.GetUGCResourcesFullPath('Asset/Blueprint/Enemy/Spawn/EntryParticle1.EntryParticle1_C'))
local EnenmyNumList ={
{
    3,3,5
}
...
local SpawnTime = 1
local Level =1;
local EntrySound = UE.LoadObject(UGCGameSystem.GetUGCResourcesFullPath('Asset/WwiseEvent/iceattack_1_1__1.iceattack_1_1__1')) --UGCGameSystem.GetUGCResourcesFullPath('Asset/WwiseEvent/iceattack_1_1__1.iceattack_1_1__1')
