---@class SpawnCarbin3_1_C:LevelSequenceActor
--Edit Below--
...
function SpawnFirstBoss:ReceiveBeginPlay()
        ...
        function()      
            ...
            if self:HasAuthority() then --UGCGameSystem.GetUGCResourcesFullPath('Asset/Blueprint/Enemy/Tank/Tank.Tank_C')
                ...
                local BP_Monster = ScriptGameplayStatics.SpawnActor(self, Class_Monster, 
                                {X=11674.004883,Y=20130.000000,Z=-20.000000},    --坐标
    ...
    KismetSystemLibrary.K2_SetTimerDelegateForLua(oBTimerDelegate1, self, 20, false)
    
    ugcprint("sequence beginplay")
    local path = UGCGameSystem.GetUGCResourcesFullPath('Asset/UI/Captions/Carbin3_1.Carbin3_1_C')
